...
<?php echo ReCaptcha::htmlScriptTagJsApi(['version' => 'invisible']); ?>
            ...
            <div class="formcenter">
                <div class="mt20 mb35 forms">
                    <div class="login-rgister">
                        ...
                        <form method="post" id="contact_form" action="<?php echo e(url('dmcago')); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="text" name="status" value="contact" style="display: none;">

                            <h1>DMCA Infringement</h1>
                            <br> <?php if(session()->has('message')): ?>
                            ...
                            <?php echo ReCaptcha::htmlFormButton('Send Message',[ 'class' => 'btnContact formbtn', 'name' => 'btnSubmit', ]); ?>
...
<?php echo $__env->make('layouts.multi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/oyebesmartest.com/public_html/resources/views/default/dmca.blade.php ENDPATH**/ ?>