            ...
            <div class="col-md-12">
                ...
                <div class="mt20 mb35 forms">
                    <div class="login-rgister">
                        <form method="post" id="contact_form" action="<?php echo e(url('contact')); ?>">
                            <?php echo csrf_field(); ?>
                                ...
                                <h1 style="font-size:20px">Contact</h1>
                                 <h5 style="font-size: 16px;text-align: -webkit-center;margin: 0px 0px 6px 0px;">Drop Us a Message
                                   ...
                                   <?php echo ReCaptcha::htmlFormButton('Send Message',[
...
<?php echo $__env->make('layouts.multi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/oyebesmartest.com/public_html/resources/views/default/contact.blade.php ENDPATH**/ ?>