        ...
        <tr>
            <td style="width: 100%; margin: 0; padding: 0; background-color: #F2F4F6;" align="center">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <!-- Logo -->
                    <tr>
                        <td style="padding: 10px 0; text-align: center;background: linear-gradient(90deg,#160c56 0,#0b355f 95%);
    border-radius: 21px 21px 0px 0px;">
                            <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 38px; font-weight: bold; color: #ffffff; text-decoration: none; text-shadow: 0 1px 0 white;" href="{{url('/')}}" target="_blank">
                            ...
                            <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0;" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        <!-- Greeting -->
                                        <h1 style="margin-top: 0; color: #2F3133; font-size: 29px; font-weight: bold; text-align: left;">
                                            Hello!
                                          </h1>

                                        <!-- Intro -->
                                          <p style="margin-top: 0; color: #74787E; font-size: 22px; line-height: 1.5em;">
                 ...
                 background-color: #3869D4; border-radius: 3px; color: #ffffff; font-size: 24px; line-height: 27px;
                 text-align: center; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3869D4;"
                                        ...
                                        <!-- Outro -->
                                        <p style="margin-top: 0; color: #74787E; font-size: 18px; line-height: 1.5em;">
                                ...
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                        <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                            ...
                                            <a style="color: #3869D4;" href="{{url('/')}}" target="_blank">{{config('app.sitename')}}</a>.
                                            All rights reserved.
                                        </p>
                                    </td>
                                </tr>
