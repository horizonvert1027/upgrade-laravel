          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="{{url('panel/admin/images?sort=pending')}}" class="small-box-footer">Review Now <i class="fa fa-arrow-circle-right"></i></a>
              </div>
              </div><!-- ./col -->
              <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-red">
                  ...
                  <a href="{{url('InstaCronAll')}}" target="_blank" class="small-box-footer">Start Now <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-red">
                  ...
                  <a href="{{url('InstaCron')}}" target="_blank" class="small-box-footer">Start Now <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-red">
                  ...
                  <a href="{{url('WebScrapper')}}" target="_blank" class="small-box-footer">Start Now <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
            </div>
<div class="row">
                      ...
                      <ul class="products-list product-list-in-box">
                        ...
                        <li class="item">
                          <div class="product-img">
                            <img height="50" width="50" src="{{ config('app.filesurl').(config('path.thumbnail').$image->thumbnail) }}" style="height: auto !important;" />
                          </div>
                          <div class="product-info">
                            <a href="{{ url('photo') }}/{{$image->id}}" target="_blank" class="product-title">{{ Str::limit($image->title, 18, '.') }}
                        ...
                        <a class="box-footer text-center" href="{{ url('panel/admin/images') }}" class="uppercase">{{ trans('admin.view_all_images') }}</a>
                        </div><!-- /.box-body -->
                        @else
                        <div class="box-body">
                  ...
                  <div class="box-header with-border">
                    ...
                    <div class="box-body">
                      <ul class="products-list product-list-in-box">
                        ...
                        <li class="item">
                          ...
                          <div class="product-info">
                            <a href="{{ url('panel/admin/subcatimages/') }}/{{$subcat->id}}" target="_blank" class="product-title">{{ Str::limit($subcat->name,18,'.') }}
                              ...
                              <span class="label label-{{ $color_status }} pull-right">
                        ...
                        <a class="box-footer text-center" href="{{ url('panel/admin/recentsubcategories') }}" class="uppercase">View All Recents</a>
                        </div><!-- /.box-body -->
                        @else
                        <div class="box-body">
                          <h5>{{ trans('admin.no_result') }}</h5>
                        ...
                        <div class="box box-danger">
                          <div class="box-header with-border">
                            ...
                            <div class="box-body commands">
                              <a href="{{url('panel/admin/optimizecache')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Optimize:clear</a>

                              <a href="{{url('panel/admin/keygenearate')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-undo"> </i> Key Genearate</a>

                              <a href="{{url('panel/admin/removesessions')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Remove Sessions</a>

                              <a href="{{url('panel/admin/alllogclear')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"> <i class="fa fa-trash"> </i> Clear all Logs</a>

                              <a href="{{url('panel/admin/pagecacheclear')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Purge all Cache</a>

                              <a href="{{url('panel/admin/pagecacheclearsubcat')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"> <i class="fa fa-trash"> </i> Purge Subcat Cache</a>

                              <a href="{{url('panel/admin/pagecacheclearsubgroup')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"> <i class="fa fa-trash"> </i> Purge Subgroup Cache</a>


                              <a href="{{url('panel/admin/pagecacheclearhome')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Purge Home Cache</a>

                              <a href="{{url('panel/admin/pagecacheclearlatest')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Purge latest Cache </a>

                              <a href="{{url('panel/admin/pagecacheclearimages')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Purge Images Cache</a>

                              <a href="{{url('panel/admin/logclear')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Remove Laravel Log</a>

                              <a href="{{url('panel/admin/pagecacheclearcat')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"><i class="fa fa-trash"> </i> Purge Cat Cache</a>


                              <a href="{{url('log-viewer/logs')}}" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,dependent=yes,fullscreen=yes'); return false;" class="small-box-footer artisanbtn"> <i class="fa fa-file-text"> </i> View Logs</a> 
    ...
    <div class="box-body">
      <ul class="products-list product-list-in-box">
        ...
        <li class="item">
          ...
          <div class="product-info">
            <a href="{{$editlink}}" target="_blank" class="product-title">{{$allsub->name}}
            </a>
            <span class="label pull-right">
              <a href="{{ url('s').'/'.$allsub->slug}}">View</a>
            </span>
            <span class="product-description">
          ...
          <div class="box-footer text-center">
            <a href="{{url('panel/admin/subcategories/view/31?sort=allinsta')}}" class="uppercase">View Subcats sorted by (AllInsta)
            </a>
          </div><!-- /.box-footer -->
    </div><!-- /.box-body -->
  </div>
...
<div class="row">
                                          ...
                                          var csrf = "{{csrf_token()}}";
                                          $.get("{{url('getcategories/')}}/"+category,
