              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"> {{ trans('admin.pages') }}</h3>
                    ...
                    <a href="{{ url('panel/admin/pages/create') }}" class="btn btn-success pull-right">
               ...
               <tbody>
                  ...
                  @foreach( $data as $page )
                    <tr>
                      ...
                      <div class="doeksath"> 
                      <a href="{{ route('pages.edit', $page->id) }}" style="margin-right:5px" class="btn btn-success btn-xs padding-btn">
                      		{{ trans('admin.edit') }}
                      	</a> 
