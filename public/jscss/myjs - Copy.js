    ...
    if (document.querySelector) {
        var i = {
            ...
            renderItem: function(e, t) {
                var n = e.replace(t, "<b>" + t + "</b>");
                return n.length, '<div class="autocomplete-suggestion" data-val="' + e + '"><span class="keywords">' + n + '</span><a href="javascript:void(0);">&nbsp;</a></div>'
            },
        ...
        for (var a = "object" == typeof i.selector ? [i.selector] : document.querySelectorAll(i.selector), u = 0; u < a.length; u++) {
            var l = a[u];
            document.getElementsByClassName("autocomplete-suggestions").length ? (l.sc = document.getElementsByClassName("autocomplete-suggestions")[0], l.sc.innerHTML = "") : l.sc = document.createElement("div"), l.sc.className = "autocomplete-suggestions " + i.menuClass, l.autocompleteAttr = l.getAttribute("autocomplete"), l.setAttribute("autocomplete", "off"), l.cache = {}, l.last_val = "", l.updateSC = function(e, t) {
                var n = l.getBoundingClientRect();
                if (l.sc.style.left = Math.round(n.left + (window.pageXOffset || document.documentElement.scrollLeft) + i.offsetLeft) + "px", l.sc.style.right = Math.round(n.right + (window.pageXOffset || document.documentElement.scrollRight) + i.offsetRight) + "px", l.sc.style.top = Math.round(n.bottom + 7 + (window.pageYOffset || document.documentElement.scrollTop) + i.offsetTop) + "px", l.sc.style.width = Math.round(n.right - n.left + 33) + "px", !e && (l.sc.style.display = "block", l.sc.maxHeight || (l.sc.maxHeight = parseInt((window.getComputedStyle ? getComputedStyle(l.sc, null) : l.sc.currentStyle).maxHeight)), l.sc.suggestionHeight || (l.sc.suggestionHeight = l.sc.querySelector(".autocomplete-suggestion").offsetHeight), l.sc.suggestionHeight))
                    if (t) {
            ...
            }, n(window, "resize", l.updateSC), document.body.appendChild(l.sc), o("autocomplete-suggestion", "mouseleave", (function(e) {
                var t = l.sc.querySelector(".autocomplete-suggestion.selected");
                t && setTimeout((function() {
                    t.className = "autocomplete-suggestion"
                }), 20)
            }), l.sc), o("autocomplete-suggestion", "mouseout", (function(e) {
                var t = l.sc.querySelector(".autocomplete-suggestion.selected");
                t && setTimeout((function() {
                    t.className = "autocomplete-suggestion"
                }), 20), this.className = "autocomplete-suggestion"
            }), l.sc), o("autocomplete-suggestion", "mouseover", (function(e) {
                var t = l.sc.querySelector(".autocomplete-suggestion.selected");
            ...
            var c = function(e) {
                var t = l.value;
                if (l.cache[t] = e, e.length && t.length >= i.minChars) {
                    for (var n = "", r = 0; r < e.length; r++) n += i.renderItem(e[r], t);
                    l.sc.innerHTML = n, l.updateSC(0)
                }
            };
            l.keydownHandler = function(e) {
                var t, n = window.event ? e.keyCode : e.which;
                if ((40 == n || 38 == n) && l.sc.innerHTML) return (r = l.sc.querySelector(".autocomplete-suggestion.selected")) ? (t = 40 == n ? r.nextSibling : r.previousSibling) ? (r.className = r.className.replace("selected", ""), t.className += " selected", l.value = t.getAttribute("data-val")) : (r.className = r.className.replace("selected", ""), l.value = l.last_val, t = 0) : ((t = 40 == n ? l.sc.querySelector(".autocomplete-suggestion") : l.sc.childNodes[l.sc.childNodes.length - 1]).className += " selected", l.value = t.getAttribute("data-val")), l.updateSC(0, t), !1;
                if (27 == n) l.value = l.last_val, l.sc.style.display = "none";
                else if (13 == n || 9 == n) {
                    var r;
                    (r = l.sc.querySelector(".autocomplete-suggestion.selected")) && "none" != l.sc.style.display && (i.onSelect(e, r.getAttribute("data-val"), r), setTimeout((function() {
                        l.sc.style.display = "none"
                    }), 20))
                }
            }, n(l, "keydown", l.keydownHandler), l.keyupHandler = function(e) {
                    ...
                    if (n.length >= i.minChars) {
                        if (n != l.last_val) {
                            if (l.last_val = n, clearTimeout(l.timer), i.cache) {
                                if (n in l.cache) return void c(l.cache[n]);
                                for (var r = 1; r < n.length - i.minChars; r++) {
                                    var o = n.slice(0, n.length - r);
                                    if (o in l.cache && !l.cache[o].length) return void c([])
                                }
                            }
            ...
            }, n(l, "keyup", l.keyupHandler), l.focusHandler = function(e) {
                l.last_val = "\n", l.keyupHandler(e)
        ...
        }, this.updatesource = function(e) {
            c(e)
        }
    }
};
if ("function" == typeof define && define.amd ? define("autoComplete", (function() {
        return autoComplete
    })) : "undefined" != typeof module && module.exports ? module.exports = autoComplete : window.autoComplete = autoComplete, function(e, t) {
        ...
        function i() {
            X.removeEventListener("DOMContentLoaded", i), e.removeEventListener("load", i), Z.ready()
        }
        ...
        function d(e, t, n, r, o) {
            for (var i, s, a, u, d, f, p = t.createDocumentFragment(), h = [], g = 0, v = e.length; v > g; g++)
                if ((i = e[g]) || 0 === i)
                    if ("object" === Z.type(i)) Z.merge(h, i.nodeType ? [i] : i);
                    else if (je.test(i)) {
                for (s = s || p.appendChild(t.createElement("div")), a = (Ne.exec(i) || ["", ""])[1].toLowerCase(), u = Le[a] || Le._default, s.innerHTML = u[1] + Z.htmlPrefilter(i) + u[2], f = u[0]; f--;) s = s.lastChild;
                Z.merge(h, s.childNodes), (s = p.firstChild).textContent = ""
            } else h.push(t.createTextNode(i));
            for (p.textContent = "", g = 0; i = h[g++];)
                if (r && Z.inArray(i, r) > -1) o && o.push(i);
                else if (d = Z.contains(i.ownerDocument, i), s = l(p.appendChild(i), "script"), d && c(s), n)
                for (f = 0; i = s[f++];) De.test(i.type || "") && n.push(i);
            return p
        }
        ...
        function x(e, t) {
            var n, r, o, i, s, a, u, l;
            if (1 === t.nodeType) {
                if (ye.hasData(e) && (i = ye.access(e), s = ye.set(t, i), l = i.events))
        ...
        function w(e, t, n, r) {
            ...
            var o, i, s, a, u, c, f = 0,
                ...
                g = t[0],
                v = Z.isFunction(g);
            if (v || p > 1 && "string" == typeof g && !K.checkClone && Re.test(g)) return e.each((function(o) {
                var i = e.eq(o);
                v && (t[0] = g.call(this, o, i.html())), w(i, t, n, r)
            }));
            if (p && (i = (o = d(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = i), i || r)) {
                for (a = (s = Z.map(l(o, "script"), m)).length; p > f; f++) u = o, f !== h && (u = Z.clone(u, !0, !0), a && Z.merge(s, l(u, "script"))), n.call(e[f], u, f);
                if (a)
                    for (c = s[s.length - 1].ownerDocument, Z.map(s, y), f = 0; a > f; f++) u = s[f], De.test(u.type || "") && !ye.access(u, "globalEval") && Z.contains(c, u) && (u.src ? Z._evalUrl && Z._evalUrl(u.src) : Z.globalEval(u.textContent.replace(Fe, "")))
            }
            return e
        }
        ...
        function k(e) {
            var t = X,
                n = We[e];
            return n || ("none" !== (n = T(e, t)) && n || ((t = (Me = (Me || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(), t.close(), n = T(e, t), Me.detach()), We[e] = n), n
        }

        function E(e, t, n) {
            var r, o, i, s, a = e.style;
            return "" !== (s = (n = n || _e(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), n && !K.pixelMarginRight() && Be.test(s) && Ie.test(t) && (r = a.width, o = a.minWidth, i = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = o, a.maxWidth = i), void 0 !== s ? s + "" : s
        }
        ...
        function L(e, t, n, r, o) {
            for (var i = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > i; i += 2) "margin" === n && (s += Z.css(e, n + ke[i], !0, o)), r ? ("content" === n && (s -= Z.css(e, "padding" + ke[i], !0, o)), "margin" !== n && (s -= Z.css(e, "border" + ke[i] + "Width", !0, o))) : (s += Z.css(e, "padding" + ke[i], !0, o), "padding" !== n && (s += Z.css(e, "border" + ke[i] + "Width", !0, o)));
            return s
        }
        ...
        function j(e, t, n) {
            ...
            return o + L(e, t, n || (s ? "border" : "content"), r, i) + "px"
        }

        function A(e, t) {
            for (var n, r, o, i = [], s = 0, a = e.length; a > s; s++)(r = e[s]).style && (i[s] = ye.get(r, "olddisplay"), n = r.style.display, t ? (i[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ee(r) && (i[s] = ye.access(r, "olddisplay", k(r.nodeName)))) : (o = Ee(r), "none" === n && o || ye.set(r, "olddisplay", o ? n : Z.css(r, "display"))));
        ...
        function R(e, t, n) {
            var r, o, i = 0,
                ...
                u = function() {
                    if (o) return !1;
                    for (var t = Je || $(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), i = 0, s = l.tweens.length; s > i; i++) l.tweens[i].run(r);
        ...
        function I(e, t, n, r) {
            ...
            if (Z.isArray(t)) Z.each(t, (function(t, o) {
                n || Ct.test(e) ? r(e, o) : I(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, r)
            }));
        ...
        Z.fn = Z.prototype = {
            ...
            for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || Z.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++)
                if (null != (e = arguments[a]))
                    for (t in e) n = s[t], s !== (r = e[t]) && (l && r && (Z.isPlainObject(r) || (o = Z.isArray(r))) ? (o ? (o = !1, i = n && Z.isArray(n) ? n : []) : i = n && Z.isPlainObject(n) ? n : {}, s[t] = Z.extend(l, i, r)) : void 0 !== r && (s[t] = r));
            return s
        }, Z.extend({
            ...
            globalEval: function(e) {
                var t, n = eval;
                (e = Z.trim(e)) && (1 === e.indexOf("use strict") ? ((t = X.createElement("script")).text = e, X.head.appendChild(t).parentNode.removeChild(t)) : n(e))
            },
            ...
            proxy: function(e, t) {
                var n, r, o;
                return "string" == typeof t && (n = e[t], t = e, e = n), Z.isFunction(e) ? (r = z.call(arguments, 2), (o = function() {
        ...
        var oe = function(e) {
            function t(e, t, n, r) {
                var o, i, s, a, u, l, d, p, h = t && t.ownerDocument,
                    g = t ? t.nodeType : 9;
                ...
                if (!r && ((t ? t.ownerDocument || t : W) !== q && A(t), t = t || q, H)) {
                    ...
                    if (w.qsa && !z[e + " "] && (!O || !O.test(e))) {
                        if (1 !== g) h = t, p = e;
                            ...
                            for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = M), i = (d = E(e)).length, u = fe.test(a) ? "#" + a : "[id='" + a + "']"; i--;) d[i] = u + " " + f(d[i]);
            ...
            function p(e, t, n) {
                ...
                return t.first ? function(t, n, i) {
                    ...
                    if (s) {
                        ...
                        for (; t = t[r];)
                            if (1 === t.nodeType || o) {
                                if ((a = (u = (l = t[M] || (t[M] = {}))[t.uniqueID] || (l[t.uniqueID] = {}))[r]) && a[0] === I && a[1] === i) return c[2] = a[2];
            ...
            function m(e, t, n, o, i, s) {
                return o && !o[M] && (o = m(o)), i && !i[M] && (i = m(i, s)), r((function(r, s, a, u) {
                    var l, c, d, f = [],
                        p = [],
                        h = s.length,
                        m = r || g(t || "*", a.nodeType ? [a] : a, []),
                        y = !e || !r && t ? m : v(m, f, e, a, u),
                        x = n ? i || (r ? e : h || o) ? [] : s : y;
                    if (n && n(y, x, a, u), o)
                        for (l = v(x, p), o(l, [], a, u), c = l.length; c--;)(d = l[c]) && (x[p[c]] = !(y[p[c]] = d));
                    if (r) {
                        if (i || e) {
                            if (i) {
                    ...
                    } else x = v(x === s ? x.splice(h, x.length) : x), i ? i(null, s, x, u) : K.apply(s, x)
                }))
            }

            function y(e) {
                for (var t, n, r, o = e.length, i = C.relative[e[0].type], s = i || C.relative[" "], a = i ? 1 : 0, u = p((function(e) {
                        return e === t
                    }), s, !0), l = p((function(e) {
                        return ee(t, e) > -1
                    ...
                    if (n = C.relative[e[a].type]) c = [p(h(c), n)];
                        ...
                        if ((n = C.filter[e[a].type].apply(null, e[a].matches))[M]) {
                            ...
                            return m(a > 1 && h(c), a > 1 && f(e.slice(0, a - 1).concat({
                                value: " " === e[a - 2].type ? "*" : ""
                            })).replace(ae, "$1"), n, r > a && y(e.slice(a, r)), o > r && y(e = e.slice(r)), o > r && f(e))
                        }
                        c.push(n)
                    }
                return h(c)
                ...
                var o = n.length > 0,
                    ...
                    s = function(r, s, a, u, l) {
                        ...
                        for (l && (D = s === q || s || l); h !== w && null != (c = x[h]); h++) {
                            if (i && c) {
                                for (d = 0, s || c.ownerDocument === q || (A(c), a = !H); f = e[d++];)
                                    if (f(c, s || q, a)) {
                                        u.push(c);
                                        break
                                    }
            ...
            var b, w, C, T, k, E, S, N, D, L, j, A, q, $, H, O, R, P, F, M = "sizzle" + 1 * new Date,
                W = e.document,
                I = 0,
                B = 0,
                _ = n(),
            ...
            for (b in w = t.support = {}, k = t.isXML = function(e) {
                    ...
                    return r !== q && 9 === r.nodeType && r.documentElement ? ($ = (q = r).documentElement, H = !k(q), (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), w.attributes = o((function(e) {
                        return e.className = "i", !e.getAttribute("className")
                    })), w.getElementsByTagName = o((function(e) {
                        return e.appendChild(q.createComment("")), !e.getElementsByTagName("*").length
                    })), w.getElementsByClassName = ve.test(q.getElementsByClassName), w.getById = o((function(e) {
                    ...
                    }, R = [], O = [], (w.qsa = ve.test(q.querySelectorAll)) && (o((function(e) {
                    ...
                    }))), (w.matchesSelector = ve.test(P = $.matches || $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && o((function(e) {
                        w.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), R.push("!=", ie)
                    })), O = O.length && new RegExp(O.join("|")), R = R.length && new RegExp(R.join("|")), t = ve.test($.compareDocumentPosition), F = t || ve.test($.contains) ? function(e, t) {
                        ...
                        return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === W && F(W, e) ? -1 : t === q || t.ownerDocument === W && F(W, t) ? 1 : L ? ee(L, e) - ee(L, t) : 0 : 4 & n ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return j = !0, 0;
                        var n, r = 0,
                            o = e.parentNode,
                            ...
                            a = [e],
                            u = [t];
                        if (!o || !i) return e === q ? -1 : t === q ? 1 : o ? -1 : i ? 1 : L ? ee(L, e) - ee(L, t) : 0;
                        if (o === i) return s(e, t);
                    ...
                    if ((e.ownerDocument || e) !== q && A(e), n = n.replace(ce, "='$1']"), w.matchesSelector && H && !z[n + " "] && (!R || !R.test(n)) && (!O || !O.test(n))) try {
                        var r = P.call(e, n);
                    ...
                    var t, n = [],
                        r = 0,
                        o = 0;
                    if (j = !w.detectDuplicates, L = !w.sortStable && e.slice(0), e.sort(U), j) {
                            ...
                            return 1 === r && 0 === o ? function(e) {
                                ...
                                if (v) {
                                    ...
                                    if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                        for (x = (p = (l = (c = (d = (f = v)[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === I && l[1]) && l[2], f = p && v.childNodes[p]; f = ++p && f && f[g] || (x = p = 0) || h.pop();)
                                            if (1 === f.nodeType && ++x && f === t) {
                                                c[e] = [I, p, x];
                                                break
                                            }
                                    } else if (y && (x = p = (l = (c = (d = (f = t)[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === I && l[1]), !1 === x)
                                        for (;
                                            (f = ++p && f && f[g] || (x = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++x || (y && ((c = (d = f[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [I, x]), f !== t)););
            ...
            return d.prototype = C.filters = C.pseudos, C.setFilters = new d, E = t.tokenize = function(e, n) {
                var r, o, i, s, a, u, l, c = X[e + " "];
                if (c) return n ? 0 : c.slice(0);
                for (a = e, u = [], l = C.preFilter; a;) {
                    for (s in r && !(o = ue.exec(a)) || (o && (a = a.slice(o[0].length) || a), u.push(i = [])), r = !1, (o = le.exec(a)) && (r = o.shift(), i.push({
                            value: r,
                            type: o[0].replace(ae, " ")
                        }), a = a.slice(r.length)), C.filter) !(o = pe[s].exec(a)) || l[s] && !(o = l[s](o)) || (r = o.shift(), i.push({
                        value: r,
                        type: s,
                        matches: o
                    }), a = a.slice(r.length));
            ...
            }, w.sortStable = M.split("").sort(U).join("") === M, w.detectDuplicates = !!j, A(), w.sortDetached = o((function(e) {
        ...
        (Z.fn.init = function(e, t, n) {
            ...
            if (n = n || ce, "string" == typeof e) {
                ...
                return (o = X.getElementById(r[2])) && o.parentNode && (this.length = 1, this[0] = o), this.context = X, this.selector = e, this
            }
        ...
        Z.Callbacks = function(e) {
                ...
                l = {
                    ...
                    remove: function() {
                        return Z.each(arguments, (function(e, t) {
                            for (var n;
                                (n = Z.inArray(t, i, n)) > -1;) i.splice(n, 1), a >= n && a--
                        })), this
                    },
                    has: function(e) {
            ...
            when: function(e) {
                var t, n, r, o = 0,
                    ...
                    l = function(e, n, r) {
                        return function(o) {
                            n[e] = this, r[e] = arguments.length > 1 ? z.call(arguments) : o, r === t ? u.notifyWith(n, r) : --a || u.resolveWith(n, r)
                        }
                    };
                if (s > 1)
                    for (t = new Array(s), n = new Array(s), r = new Array(s); s > o; o++) i[o] && Z.isFunction(i[o].promise) ? i[o].promise().progress(l(o, n, t)).done(l(o, r, i)).fail(u.reject) : --a;
            ...
            ready: function(e) {
                (!0 === e ? --Z.readyWait : Z.isReady) || (Z.isReady = !0, !0 !== e && --Z.readyWait > 0 || (he.resolveWith(X, [Z]), Z.fn.triggerHandler && (Z(X).triggerHandler("ready"), Z(X).off("ready"))))
            }
        }), Z.ready.promise = function(t) {
            return he || (he = Z.Deferred(), "complete" === X.readyState || "loading" !== X.readyState && !X.documentElement.doScroll ? e.setTimeout(Z.ready) : (X.addEventListener("DOMContentLoaded", i), e.addEventListener("load", i))), he.promise(t)
        }, Z.ready.promise();
        var ve = function(e, t, n, r, o, i, s) {
                var a = 0,
                    u = e.length,
                    l = null == n;
                if ("object" === Z.type(n))
                    for (a in o = !0, n) ve(e, t, a, n[a], !0, i, s);
                else if (void 0 !== r && (o = !0, Z.isFunction(r) || (s = !0), l && (s ? (t.call(e, r), t = null) : (l = t, t = function(e, t, n) {
                        return l.call(Z(e), n)
                    })), t))
        ...
        Z.event = {
            ...
            add: function(e, t, n, r, o) {
                var i, s, a, u, l, c, d, f, p, h, g, v = ye.get(e);
                if (v)
                    for (n.handler && (n = (i = n).handler, o = i.selector), n.guid || (n.guid = Z.guid++), (u = v.events) || (u = v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
                            return void 0 !== Z && Z.event.triggered !== t.type ? Z.event.dispatch.apply(e, arguments) : void 0
                        }), l = (t = (t || "").match(ge) || [""]).length; l--;) p = g = (a = $e.exec(t[l]) || [])[1], h = (a[2] || "").split(".").sort(), p && (d = Z.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = Z.event.special[p] || {}, c = Z.extend({
                        type: p,
                        origType: g,
                        data: r,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, i), (f = u[p]) || ((f = u[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, r, h, s) || e.addEventListener && e.addEventListener(p, s)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, c) : f.push(c), Z.event.global[p] = !0)
            },
            remove: function(e, t, n, r, o) {
                var i, s, a, u, l, c, d, f, p, h, g, v = ye.hasData(e) && ye.get(e);
                if (v && (u = v.events)) {
                    for (l = (t = (t || "").match(ge) || [""]).length; l--;)
                        if (p = g = (a = $e.exec(t[l]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                            for (d = Z.event.special[p] || {}, f = u[p = (r ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = i = f.length; i--;) c = f[i], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (f.splice(i, 1), c.selector && f.delegateCount--, d.remove && d.remove.call(e, c));
                            s && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, v.handle) || Z.removeEvent(e, p, v.handle), delete u[p])
                        } else
                ...
                if (a[0] = e, e.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                    for (s = Z.event.handlers.call(this, e, u), t = 0;
                        ...
                        for (e.currentTarget = o.elem, n = 0;
                            (i = o.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(i.namespace) || (e.handleObj = i, e.data = i.data, void 0 !== (r = ((Z.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, a)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
            ...
            mouseHooks: {
                ...
                filter: function(e, t) {
                    ...
                    return null == e.pageX && null != t.clientX && (r = (n = e.target.ownerDocument || X).documentElement, o = n.body, e.pageX = t.clientX + (r && r.scrollLeft || o && o.scrollLeft || 0) - (r && r.clientLeft || o && o.clientLeft || 0), e.pageY = t.clientY + (r && r.scrollTop || o && o.scrollTop || 0) - (r && r.clientTop || o && o.clientTop || 0)), e.which || void 0 === i || (e.which = 1 & i ? 1 : 2 & i ? 3 : 4 & i ? 2 : 0), e
                }
            },
            fix: function(e) {
                ...
                var t, n, r, o = e.type,
                    i = e,
                    s = this.fixHooks[o];
                for (s || (this.fixHooks[o] = s = qe.test(o) ? this.mouseHooks : Ae.test(o) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new Z.Event(i), t = r.length; t--;) e[n = r[t]] = i[n];
            ...
            return this instanceof Z.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? f : p) : this.type = e, t && Z.extend(this, t), this.timeStamp = e && e.timeStamp || Z.now(), void(this[Z.expando] = !0)) : new Z.Event(e, t)
        }, Z.Event.prototype = {
            constructor: Z.Event,
        ...
        Z.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (!(K.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || Z.isXMLDoc(e)))
                    for (s = l(a), r = 0, o = (i = l(e)).length; o > r; r++) b(i[r], s[r]);
                if (t)
                    if (n)
                        for (i = i || l(e), s = s || l(a), r = 0, o = i.length; o > r; r++) x(i[r], s[r]);
                    else x(e, a);
            ...
            html: function(e) {
                return ve(this, (function(e) {
                    ...
                    if ("string" == typeof e && !Oe.test(e) && !Le[(Ne.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = Z.htmlPrefilter(e);
                        try {
            ...
            Z.fn[e] = function(e) {
                for (var n, r = [], o = Z(e), i = o.length - 1, s = 0; i >= s; s++) n = s === i ? this : this.clone(!0), Z(o[s])[t](n), V.apply(r, n.get());
        ...
        ! function() {
            function t() {
                ...
                n = "1%" !== t.top, i = "2px" === t.marginLeft, r = "4px" === t.width, a.style.marginRight = "50%", o = "4px" === t.marginRight, ze.removeChild(s)
            }
            var n, r, o, i, s = X.createElement("div"),
        ...
        Z.extend({
            ...
            style: function(e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var o, i, s, a = Z.camelCase(t),
                        l = e.style;
                    return t = Z.cssProps[a] || (Z.cssProps[a] = N(a) || a), s = Z.cssHooks[t] || Z.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(e, !1, r)) ? o : l[t] : ("string" == (i = typeof n) && (o = Te.exec(n)) && o[1] && (n = u(e, t, o), i = "number"), void(null != n && n == n && ("number" === i && (n += o && o[3] || (Z.cssNumber[a] ? "" : "px")), K.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (l[t] = n))))
                }
            },
            css: function(e, t, n, r) {
                var o, i, s, a = Z.camelCase(t);
                return t = Z.cssProps[a] || (Z.cssProps[a] = N(a) || a), (s = Z.cssHooks[t] || Z.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = E(e, t, r)), "normal" === o && t in Ye && (o = Ye[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
            }
            ...
            Z.cssHooks[t] = {
                ...
                set: function(e, n, r) {
                    var o, i = r && _e(e),
                        s = r && L(e, t, r, "border-box" === Z.css(e, "boxSizing", !1, i), i);
                    return s && (o = Te.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = Z.css(e, t)), D(0, n, s)
                }
            }
            ...
            }, Ie.test(e) || (Z.cssHooks[e + t].set = D)
        })), Z.fn.extend({
            css: function(e, t) {
            ...
            run: function(e) {
                ...
                return this.options.duration ? this.pos = t = Z.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : q.propHooks._default.set(this), this
            }
            ...
            _default: "swing"
        }, Z.fx = q.prototype.init, Z.fx.step = {};
        ...
        Z.Animation = Z.extend(R, {
                ...
                prefilters: [function(e, t, n) {
                    ...
                    for (r in n.queue || (null == (a = Z._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, u = a.empty.fire, a.empty.fire = function() {
                        ...
                        }))), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], "inline" === ("none" === (l = Z.css(e, "display")) ? ye.get(e, "olddisplay") || k(e.nodeName) : l) && "none" === Z.css(e, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", c.always((function() {
                    ...
                    if (Z.isEmptyObject(d)) "inline" === ("none" === l ? k(e.nodeName) : l) && (f.display = l);
                        ...
                        for (r in h ? "hidden" in h && (p = h.hidden) : h = ye.access(e, "fxshow", {}), i && (h.hidden = !p), p ? Z(e).show() : c.done((function() {
                                Z(e).hide()
                            })), c.done((function() {
                                var t;
                                for (t in ye.remove(e, "fxshow"), d) Z.style(e, t, d[t])
                            })), d) s = O(p ? h[r] : 0, r, c), r in h || (h[r] = s.start, p && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
                }],
                ...
                return t = Z.fx && Z.fx.speeds[t] || t, n = n || "fx", this.queue(n, (function(n, r) {
        ...
        Z.fn.extend({
            ...
            attr: function(e, t, n) {
                ...
                return 3 !== i && 8 !== i && 2 !== i ? void 0 === e.getAttribute ? Z.prop(e, t, n) : (1 === i && Z.isXMLDoc(e) || (t = t.toLowerCase(), o = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? tt : void 0)), void 0 !== n ? null === n ? void Z.removeAttr(e, t) : o && "set" in o && void 0 !== (r = o.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (r = o.get(e, t)) ? r : null == (r = Z.find.attr(e, t)) ? void 0 : r) : void 0
            },
            attrHooks: {
                type: {
                    set: function(e, t) {
        ...
        Z.fn.extend({
            ...
            prop: function(e, t, n) {
                var r, o, i = e.nodeType;
                return 3 !== i && 8 !== i && 2 !== i ? (1 === i && Z.isXMLDoc(e) || (t = Z.propFix[t] || t, o = Z.propHooks[t]), void 0 !== n ? o && "set" in o && void 0 !== (r = o.set(e, n, t)) ? r : e[t] = n : o && "get" in o && null !== (r = o.get(e, t)) ? r : e[t]) : void 0
            },
            propHooks: {
                tabIndex: {
                    get: function(e) {
        ...
        Z.fn.extend({
            addClass: function(e) {
                ...
                if (Z.isFunction(e)) return this.each((function(t) {
                    Z(this).addClass(e.call(this, t, P(this)))
                }));
                if ("string" == typeof e && e)
                    for (t = e.match(ge) || []; n = this[u++];)
                        if (o = P(n), r = 1 === n.nodeType && (" " + o + " ").replace(it, " ")) {
            ...
            removeClass: function(e) {
                var t, n, r, o, i, s, a, u = 0;
                if (Z.isFunction(e)) return this.each((function(t) {
                    Z(this).removeClass(e.call(this, t, P(this)))
                }));
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : Z.isFunction(e) ? this.each((function(n) {
                    Z(this).toggleClass(e.call(this, n, P(this), t), t)
                })) : this.each((function() {
                    var t, r, o, i;
                    if ("string" === n)
                        for (r = 0, o = Z(this), i = e.match(ge) || []; t = i[r++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                    else void 0 !== e && "boolean" !== n || ((t = P(this)) && ye.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : ye.get(this, "__className__") || ""))
                }))
            },
            hasClass: function(e) {
                var t, n, r = 0;
                for (t = " " + e + " "; n = this[r++];)
                    if (1 === n.nodeType && (" " + P(n) + " ").replace(it, " ").indexOf(t) > -1) return !0;
                return !1
            }
        });
        var st = /\r/g,
        ...
        Z.extend(Z.event, {
            trigger: function(t, n, r, o) {
                var i, s, a, u, l, c, d, f = [r || X],
                    p = J.call(t, "type") ? t.type : t,
                    h = J.call(t, "namespace") ? t.namespace.split(".") : [];
                if (s = a = r = r || X, 3 !== r.nodeType && 8 !== r.nodeType && !ut.test(p + Z.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, (t = t[Z.expando] ? t : new Z.Event(p, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), d = Z.event.special[p] || {}, o || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                    if (!o && !d.noBubble && !Z.isWindow(r)) {
                        for (u = d.delegateType || p, ut.test(u + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), a = s;
                        a === (r.ownerDocument || X) && f.push(a.defaultView || a.parentWindow || e)
                    }
                    for (i = 0;
                        (s = f[i++]) && !t.isPropagationStopped();) t.type = i > 1 ? u : d.bindType || p, (c = (ye.get(s, "events") || {})[t.type] && ye.get(s, "handle")) && c.apply(s, n), (c = l && s[l]) && c.apply && me(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
                    return t.type = p, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !me(r) || l && Z.isFunction(r[p]) && !Z.isWindow(r) && ((a = r[l]) && (r[l] = null), Z.event.triggered = p, r[p](), Z.event.triggered = void 0, a && (r[l] = a)), t.result
                }
            },
        ...
        bt.href = lt.href, Z.extend({
            ...
            ajax: function(e, t) {
                function n(e, t, n, s) {
                    var u, c, m, y, b, T = t;
                    2 !== x && (x = 2, a && C.clearTimeout(a), r = void 0, i = s || "", w.readyState = e > 0 ? 4 : 0, u = e >= 200 && 300 > e || 304 === e, n && (y = function(e, t, n) {
                    ...
                    }(d, y, w, u), u ? (d.ifModified && ((b = w.getResponseHeader("Last-Modified")) && (Z.lastModified[o] = b), (b = w.getResponseHeader("etag")) && (Z.etag[o] = b)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, c = y.data, u = !(m = y.error))) : (m = T, !e && T || (T = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || T) + "", u ? h.resolveWith(f, [c, T, w]) : h.rejectWith(f, [w, T, m]), w.statusCode(v), v = void 0, l && p.trigger(u ? "ajaxSuccess" : "ajaxError", [w, d, u ? c : m]), g.fireWith(f, [w, T]), l && (p.trigger("ajaxComplete", [w, d]), --Z.active || Z.event.trigger("ajaxStop")))
                }
                "object" == typeof e && (t = e, e = void 0), t = t || {};
                var r, o, i, s, a, u, l, c, d = Z.ajaxSetup({}, t),
                    f = d.context || d,
                ...
                if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || lt.href) + "").replace(ft, "").replace(vt, lt.protocol + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = Z.trim(d.dataType || "*").toLowerCase().match(ge) || [""], null == d.crossDomain) {
                    u = X.createElement("a");
                    try {
                ...
                if (d.data && d.processData && "string" != typeof d.data && (d.data = Z.param(d.data, d.traditional)), M(mt, d, t, w), 2 === x) return w;
                for (c in (l = Z.event && d.global) && 0 == Z.active++ && Z.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !gt.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (dt.test(o) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (d.url = pt.test(o) ? o.replace(pt, "$1_=" + ct++) : o + (dt.test(o) ? "&" : "?") + "_=" + ct++)), d.ifModified && (Z.lastModified[o] && w.setRequestHeader("If-Modified-Since", Z.lastModified[o]), Z.etag[o] && w.setRequestHeader("If-None-Match", Z.etag[o])), (d.data && d.hasContent && !1 !== d.contentType || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + xt + "; q=0.01" : "") : d.accepts["*"]), d.headers) w.setRequestHeader(c, d.headers[c]);
                ...
                if (r = M(yt, d, t, w)) {
                    ...
                    d.async && d.timeout > 0 && (a = C.setTimeout((function() {
                        w.abort("timeout")
                    }), d.timeout));
                    try {
                        x = 1, r.send(m, n)
            ...
            Z[t] = function(e, n, r, o) {
                return Z.isFunction(n) && (o = o || r, r = n, n = void 0), Z.ajax(Z.extend({
                    url: e,
                    type: t,
                    dataType: o,
                    data: n,
        ...
        K.cors = !!Nt && "withCredentials" in Nt, K.ajax = Nt = !!Nt, Z.ajaxTransport((function(e) {
            var t, n;
            return K.cors || Nt && !e.crossDomain ? {
                send: function(r, o) {
                    ...
                    t = function(e) {
                        return function() {
                            t && (t = n = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(St[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                binary: s.response
                            } : {
                                text: s.responseText
        ...
        Z.ajaxSetup({
            ...
            var o, i, s, a = !1 !== t.jsonp && (Lt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Lt.test(t.data) && "data");
            return a || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Lt, "$1" + o) : !1 !== t.jsonp && (t.url += (dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
                return s || Z.error(o + " was not called"), s[0]
            }, t.dataTypes[0] = "json", i = e[o], e[o] = function() {
                s = arguments
            }, r.always((function() {
                void 0 === i ? Z(e).removeProp(o) : e[o] = i, t[o] && (t.jsonpCallback = n.jsonpCallback, Dt.push(o)), s && Z.isFunction(i) && i(s[0]), s = i = void 0
            })), "script") : void 0
        ...
        Z.fn.load = function(e, t, n) {
            ...
            var r, o, i, s = this,
                a = e.indexOf(" ");
            return a > -1 && (r = Z.trim(e.slice(a)), e = e.slice(0, a)), Z.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), s.length > 0 && Z.ajax({
                url: e,
                type: o || "GET",
                dataType: "html",
                data: t
            ...
            setOffset: function(e, t, n) {
                var r, o, i, s, a, u, l = Z.css(e, "position"),
                    c = Z(e),
                    d = {};
                "static" === l && (e.style.position = "relative"), a = c.offset(), i = Z.css(e, "top"), u = Z.css(e, "left"), ("absolute" === l || "fixed" === l) && (i + u).indexOf("auto") > -1 ? (s = (r = c.position()).top, o = r.left) : (s = parseFloat(i) || 0, o = parseFloat(u) || 0), Z.isFunction(t) && (t = t.call(e, n, Z.extend({}, a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + o), "using" in t ? t.using.call(e, d) : c.css(d)
            }
        }, Z.fn.extend({
            offset: function(e) {
                ...
                var t, n, r = this[0],
                    ...
                    i = r && r.ownerDocument;
                return i ? (t = i.documentElement, Z.contains(t, r) ? (o = r.getBoundingClientRect(), n = B(i), {
            ...
            Z.each({
                ...
                Z.fn[r] = function(r, o) {
                    ...
                    return ve(this, (function(t, n, r) {
                        var o;
                        return Z.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (o = t.documentElement, Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === r ? Z.css(t, n, s) : Z.style(t, n, r, s)
                    }), t, i ? r : void 0, i, null)
                }
            }))
        })), Z.fn.extend({
        ...
        return Z.noConflict = function(t) {
            return e.$ === Z && (e.$ = qt), t && e.jQuery === Z && (e.jQuery = At), Z
        }, t || (e.jQuery = e.$ = Z), Z
...
function(e) {
    ...
    i.VERSION = "3.3.7", i.prototype.toggle = function(r) {
        var o = e(this);
...
$(".suggest input[name='q']").keyup((function(e) {
    ...
    $.get(URL_BASE + "/ajax/searchtags?index=" + r + "&q=" + n, (function(e) {
        if (e) {
            if (console.log(e), 1 == e.error) return d = [], demo1.updatesource(d), !1;
            if (e.index != r) return !1;
            demo1.updatesource(e.data), $(".autocomplete-suggestion span").click((function(e) {
                e.preventDefault();
...
$(".hsearch input[name='q']").keyup((function(e) {
        ...
        $.get(URL_BASE + "/ajax/searchtags?index=" + r + "&q=" + n, (function(e) {
            if (e) {
                ...
                if (e.index != r) return !1;
                demo2.updatesource(e.data), $(".autocomplete-suggestion span").click((function(e) {
                    e.preventDefault();
                    var t = $(this).parent().html();
    ...
    })), toggleNavbarMethod(), $(window).resize(toggleNavbarMethod), $(document).ready((function() {
        $(".navbar-toggle").click((function() {
            $(".nc").toggleClass("in"), setTimeout((function() {
                $(".nc").hasClass("in") ? ($("body").addClass("posFixed"), $(".oc_K_s, #nvbrcls").show(), $(".nc").animate({
                    right: "0px"
                }, 50)) : ($("body").removeClass("posFixed"), $(".oc_K_s, #nvbrcls").hide(), $(".nc").animate({
                    right: "-300px"
                }, 30))
            }), 20)
        })), $("#ncc").click((function() {
            $(".nc").toggleClass("in"), $(".nc").animate({
                right: "-300px"
            }, 90), $("body").removeClass("posFixed"), setTimeout((function() {
                $(".oc_K_s, #nvbrcls").hide()
            }), 90)
        }))
    ...
    window.onclick = function(e) {
        document.body.contains(document.getElementById("myPopup")) && (document.getElementById("myPopup").classList.toggle("show"), e.target.matches("myPopup1") || e.target.matches(".tooltip") || document.getElementById("myPopup").classList.remove("show"))
    };
...
function downloadJSAtOnload() {
    ...
    o.src = googlesyndic, document.body.appendChild(o)
}
...
slide('.sliderWrapper2')
    ...
    ! function(t) {
        function e(t, a, r, n) {
            function o(t) { r.maxRows && d > r.maxRows || r.truncate && t && d > 1 ? w[g][0].style.display = "none" : (w[g][0].style.width = l + "px", w[g][0].style.height = u + "px", w[g][0].style.display = "block") }
            var g, l, s = 1,
                d = 1,
                f = t.width() - 2,
                w = [],
        ...
        t.fn.flexImages = function(a) {
            ...
            return this.each(function() {
                ...
                e(a, n, i), t(window).off("resize.flexImages" + a.data("flex-t")), t(window).on("resize.flexImages" + o, function() { e(a, n, i) }), a.data("flex-t", o)
            })
        }
    }(jQuery);
...
$(document).on('click', '.pagination a', function(e) {
    ...
    $.ajax({
        ...
        if (data) {
            scrollElement('.imagesFlex2');
            $('.dataResult').html(data);
            $('.imagesFlex2').flexImages({
                rowHeight: 320
            });
        } else {
 ...
 var offset = 50;
                    ...
                    jQuery(window).on('scroll', function() {
                                if (jQuery(this).scrollTop() > offset) {
                                    jQuery('.progress-wrap').addClass('active-progre
ss');
            } else {
